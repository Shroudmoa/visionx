...
eap_local = ""
if params.get('eapAuthentication') == 'true':
    eap_local = f"eap_id = {params['eapUserName']}"
...
print(f" Generated {health_check_path}")
...
print(f" net.ipv4.ip_forward = {ip_forward_value}")
...
print(" iptables configured and persistent")
